...
namespace Study_FH
{
    ...
    public static class ToolBox
    {
        ...
        {
            public const string PathBase = "D:\\OneDrive - ufpr.br\\Visual Studio 2019\\";
        }
        ...
        public static void FileTxt(string Nome, List<string> content, bool ShowMess)
        {
        ...
        public static void FileTxt(string Nome, StringBuilder text, bool ShowMess)
        {
            using (StreamWriter writer = new StreamWriter(Nome))
            {
                writer.WriteLine(text.ToString());
        ...
        public static Bitmap Draw2points(int qtdPts, bool random = true, int randomseed = 0)
        {
            ...
            if (random)
            {
                pts = ToolBox.CriarListaDePontos(qtdPts, 10, 490, 10, 490, randomseed);
            ...
            {
                (pts, ind) = ToolBox.CriarPontosPoligonoRegular(qtdPts, gdeRaio, XCent, YCent);
            }
        ...
        public static void Substring_lps(string filePL, string fileMST, bool ShowMess)
        {
            ...
            string NewName = filePL.Replace(".lp", "recalc(" + ToolBox.GetNow() + ").tsv");
            string val;
